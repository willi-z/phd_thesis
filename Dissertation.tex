...
DIV=14, % DIVzahl|DIV=calc - Satzspiegel (Seitenränder), ggf. geometry-Paket nutzen % TODO: auf 14 für Druckversion setzten
fontsize=12pt, % Schriftgröße
a4paper, % Papierformat a5paper|a4paper
oneside, % Ein- oder zweiseitig oneside|twoside % TODO: twoside für Druckversion nach der Verteidigung
numbers=noendperiod,
...
{Abbildungen/07_Ergebnisse/}
{Abbildungen/08_Leichtbau/}
{Abbildungen/09_Zusammenfassung/}
{Abbildungen/90_Anhang/}}
...
\hypersetup{%
       ...
       pdfcreator={pdfTeX},
       pdfsubject={Auslegung von Strukturbatterien unter Berücksichtigung der gekoppelten, multiskaligen Effekte}, % TODO: change title
...
% \include{Kapitel/00_Vorwort} % TODO(willi): erst nach der Verteidigung einfügen
...
\include{Kapitel/03_Model_Grundlagen}
\include{Kapitel/04_SBE}
\include{Kapitel/05_Multi_Skaliger_Ansatz}
\include{Kapitel/06_Analytischer_Ansatz}
\include{Kapitel/07_Ergebnisse}
\include{Kapitel/08_Leichtbau}
\include{Kapitel/09_Zusammenfassung}
...
%\printbibliography
\appendix
\include{Kapitel/90_Glossar}
\include{Kapitel/90_Materialparameter}
\include{Kapitel/91_Implementierung_Mikromechanik}
