\begin{table}[!ht]
    \centering
    \caption{\label{tab:combinations}Materialzusammensetzung und Kennwerte von getesteten und identifiziereten vielversprechenden Batterievarianten.}
    \scriptsize
    ...
    \begin{tabularx}{\textwidth}{l >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X c c c c}
        ...
        \makecell{\textbf{Energie-}\\\textbf{dichte}\\ \scriptsize \textbf{[\unit{\watt\hour\per\kilo\gram}]}} & 
        \makecell{\textbf{Biege-}\\\textbf{steifigkeit}\\ \scriptsize \textbf{[\unit{\mega\pascal}]}} & 
        \makecell{\textbf{Zug-}\\\textbf{steifigkeit}\\ \scriptsize \textbf{[\unit{\giga\pascal}]}} \\
        \midrule
        \textbf{ElViS}
