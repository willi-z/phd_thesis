\begin{table}[ht]
    \centering
    \caption{\label{tab:energy_densities}Spezifische Energie und Energiedichte für eine repräsentative \ce{LiCoO2} (LCO) Kathode und eine Graphitanode in verschiedenen Referenzsystemen.\cite{Son2021}}
    ...
    \addlinespace
    \makecell{Volumetrische\\Energiedichte\\ $\left[ \si{\watt \hour \per \liter} \right]$} & 3166 & 1527 & 19 & 414\\
    \bottomrule
    \end{tabular}
