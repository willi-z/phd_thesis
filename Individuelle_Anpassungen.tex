...
\hyphenation{Bau-teil-aus-leg-ung}
\hyphenation{Mod-ell-an-sät-ze}
\hyphenation{Yo-shi-no}
\hyphenation{Carl-stedt}
\hyphenation{Ge-wichts-ein-spar-ung}
\hyphenation{New-man}
\hyphenation{ste-re-o-mi-kros-ko-pi-sche}
\hyphenation{hy-bri-di-sier-ten}
%-------------------------------------------------------------------
