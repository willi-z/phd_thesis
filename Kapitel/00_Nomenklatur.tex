...
NCA								& Nickel-Cobalt-Aluminium-Oxid \\
NMC								& Nickel-Mangan-Cobalt-Oxid \\
...
SoC								& Ladezustand (\textit{engl.} State of Charge) \\
\end{longtable}
...
\begin{longtable}{@{}p{\TabulatorVZ}@{}p{\TabulatorTX}p{\TabulatorEH}@{}}
	...
	$c_{\text{p}}$ 		& spezifische Wärmekapazität 		& $\si{\joule\per\kilogram\per\kelvin}$ \\ \addlinespace
	...
	$U$					& elektrisches Potenzial				& $\si{\volt}$\\
...
\begin{longtable}{@{}p{\TabulatorVZ}@{}p{\TabulatorTX+\TabulatorEH+2\tabcolsep}@{}}
	...
	$x_{\text{echem}}$			& elektrochemisch\\
	$x_{\text{E}}$				& Elektrolyte\\
