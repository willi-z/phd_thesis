...
wobei die mechanischen Verschiebungen $\boldsymbol{u}$ mit \textsc{Lagrange}-Elementen zweiter Ordnung diskretisiert werden, während die übrigen Felder mit P1- oder P2-Elementen abgebildet werden.
